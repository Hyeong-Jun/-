		...
		<FORM Name='Modify' Action='modify_output.jsp' Method='POST'
			...
			<TABLE border='0' width='600'>
				...
				<TR>
					...
					<TD>
						<p>
							<input type='password' size='12' name='pass'> * 필수
						</p>
					</TD>
				</TR>
				...
				<TR>
					...
					<TD><font size='2'><input type='text' size='70'
							maxlength='50' name='title' value="<%=title%>"></font></TD>
				</TR>
				...
				<TR>
					...
					<TD><font size='2'> <textarea cols='70' rows='15'
								wrap='virtual' name='contents'><%=contents%></textarea>
					</font></TD>
				</TR>
